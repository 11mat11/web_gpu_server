...
export async function loadAiModelHandler(
	req: FastifyRequest,
	reply: FastifyReply,
...
export async function predictMlpHandler(
	req: FastifyRequest,
	reply: FastifyReply,
): Promise<FastifyReply> {
	const manager = AiManager.getInstance();
...
export async function predictCnnHandler(
	req: FastifyRequest,
	reply: FastifyReply,
): Promise<FastifyReply> {
	const manager = AiManager.getInstance();
...
export async function unloadAiModelHandler(
	req: FastifyRequest,
	reply: FastifyReply,
): Promise<FastifyReply> {
	const manager = AiManager.getInstance();
